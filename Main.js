            ...
            <View style={styles.container}>
                ...
                <View style={styles.framesContainer}>
                    <View style={styles.categoryContainer}>
                        <TouchableOpacity style={this.state.selected=="regular"? styles.categoryBoxSelected : styles.categoryBox} onPress={()=>{
                            this.setState({
                                selected:"regular"
                        })}}>
                            <Text>Regular</Text>
                        ...
                        <TouchableOpacity style={this.state.selected=="wayFarer"? styles.categoryBoxSelected : styles.categoryBox} onPress={()=>{
                            this.setState({
                                selected:"wayFarer"
                        })}}>
                            <Text>WayFarer</Text>
                        ...
                        <TouchableOpacity style={this.state.selected=="round"? styles.categoryBoxSelected : styles.categoryBox} onPress={()=>{
                            this.setState({
                                selected:"round"
                        })}}>
                            <Text>Round</Text>
                        ...
                        <TouchableOpacity style={this.state.selected=="rimless"? styles.categoryBoxSelected : styles.categoryBox} onPress={()=>{
                            this.setState({
                                selected:"rimless"
                        })}}>
                            <Text>Rimless</Text>
                        ...
                        <TouchableOpacity style={this.state.selected=="aviator"? styles.categoryBoxSelected : styles.categoryBox} onPress={()=>{
                            this.setState({
                                selected:"aviator"
                            })
                        }}>
